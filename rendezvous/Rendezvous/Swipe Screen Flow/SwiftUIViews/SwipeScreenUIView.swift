...
//    ]
    @State var profiles = [
        Profile(id:0, name:"Edward Cullen", profilePic:"profilePic",age:"65", heightFeet:"6", heightInch:"2", city:"Forks", state:"WA",selfDescription: "here to find Bella", offset: 0),
        Profile(id:1, name:"Miley Cyrus", profilePic:"profilePic",age:"28", heightFeet:"5", heightInch:"3", city:"Los Angeles", state:"CA", selfDescription: "Music!!!", offset: 0),
        Profile(id:2, name:"Jacob Black", profilePic:"profilePic",age:"27", heightFeet:"6", heightInch:"6", city:"Forks", state:"WA", selfDescription: "hello", offset: 0),
        ...
        Profile(id:4, name:"Alexa Taylor", profilePic:"profilePic",age:"22", heightFeet:"5", heightInch:"10", city:"New York City", state:"New York", selfDescription: "Energetic city girl, looking for. Good chat! Interested in people who share my passion for diversifying tech. Let’s grab avo toast once the pandemic is over!", offset: 0),
        Profile(id:5, name:"Albert Liu", profilePic:"profilePic",age:"21", heightFeet:"5", heightInch:"8", city:"New York", state:"NY", selfDescription: "Hi!", offset: 0),
        Profile(id:6, name:"Chris Kyle", profilePic:"profilePic",age:"51", heightFeet:"6", heightInch:"2", city:"Dallas", state:"Texas", selfDescription: "Worker", offset: 0),
        Profile(id:7, name:"Hubert Alexander", profilePic:"profilePic",age:"64", heightFeet:"3", heightInch:"2", city:"New York", state:"NY", selfDescription: "hello", offset: 0),
