...
//                let name = p.name
//                let age = p.age
//                let heightFeet = p.heightFeet
//                let heightInch = p.heightInch
//                let city = p.city
//                let state = p.state
//                let selfDescription = p.selfDescription
//                print("Profile(id:0, name:\"" + name + "\", image:\"image\",age:\"" + age + "\", heightFeet:\"" + heightFeet + "\", heightInch:\"" + heightInch + "\", city:\"" + city + "\", state:\"" + state + "\", selfDescription = \"" + selfDescription + "\"")
//            }
//        }
//
//    }
